...
The contraction (or stretching) of the arrival times of photons is already taken account by one of the Doppler factors in the previous section, so we do not need to multiply flux again by $\delta$. 
...
\label{table:params}
\begin{center}
  \begin{tabular}[c]{ l  c } %\begin{tabular}[c]{l c c c c c}
    \hline
    \hline
     Parameter & Value\\ \hline
      ...
      Spot angular size $\rho$ & $10 \degree$  \\ %\hline
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}
\centerline{\epsfig{file=synt_sax_pol2new.png,width=17.0cm}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}
\centerline{\epsfig{file=synt_sax_eq2new.png,width=17.0cm}}
...
It is a method to increase the signal-to-noise ratio without largely distorting the signal. This is achieved by fitting subsequent sub-sets of adjacent data points with a low-degree polynomial using the method of linear least squares. The central point of each sub-set is used to evaluate the data. The filter preserves the width of the posterior probability distribution and thus also the credible limits. Two-dimensional histograms are smoothed using a convolution with a two-dimensional Gaussian kernel with a $2\sigma_{\mathrm{E}}$ standard deviation for both axes. %add here what is sigma in pixels/parameter units? 
...
%now that we smooth stuff I would add a short paragraph to here about how that is done. I would state that MCMC methods are always noisy and we use some digital filttering to reduce this. Describe shortly that 1-dim histograms are smoothed using Savintzky-Golay filtter. Give short descrption and mention that it preserves the width of the distribution. This is done to preserve credible limits. Then say that 2dim histograms are smoothed using a convolution with a 2d Gaussian kernel. Check kernel 1sigma width, I vaguely rember it was 2 pixels which can be transformed to parameter values by multiplying with grid step width. This does not exactly preserve distribution width but we use narrow kernel and convolve multiple times to reduce effects from this.
% applied to a set of digital data points for the purpose of smoothing the data, that is, to increase the signal-to-noise ratio without greatly distorting the signal. This is achieved, in a process known as convolution, by fitting successive sub-sets of adjacent data points with a low-degree polynomial by the method of linear least squares. When the data points are equally spaced, an analytical solution to the least-squares equations can be found, in the form of a single set of "convolution coefficients" that can be applied to all data sub-sets, to give estimates of the smoothed signal, (or derivatives of the smoothed signal) at the central point of each sub-set. 
...
The non-uniform priors for $\thetas$ and $i$ have also a strong effect on the posterior probability distributions for the mass and the radius. They are now also limited on both sides of the correct values having the maximum near the correct value. The prior information shifts the probability densities of mass and radius towards higher masses and radii, since the incorrect $\thetas - i$ solutions are in this case not contributing to the small masses and radii so strongly. %For some reason, the intermediate solutions for $i$ and $\thetas$ (where neither $i$ or $\thetas$ is very large or small) seemed to favour small radii and masses, when the priors were not applied. 
It is not very clear why the intermediate solutions for $i$ and $\thetas$, where either $i$ or $\thetas$ is not particularly large or small, seem to favour small radii and masses. The incorrect solution in $\thetas$ might be compensated with a smaller $\req$ and thus also with a smaller mass, since the ratio between mass and radius is well constrained. 
  ...
  \begin{tabular}[c]{l c c c c c}
    ...
    \hline
     ...
     \multicolumn{6}{c}{Polar spot with only uniform priors} \\ %\hline
      Radius $\req$ (km) & $8.08$ & $8.34$ & $9.02$ & $12.4$ & $13.8$  \\ %\hline
      ...
      Radius $\req$ (km) & $8.46$ & $9.62$ & $11.6$ & $13.4$ & $15.2$  \\ %\hline
      Mass $M$ ($\msun$) & $1.1$ & $1.2$ & $1.4$ & $1.7$ & $1.9$  \\ %\hline
      Inclination $i$ ($\deg$) & $3.5$ & $62$ & $74$ & $83$ & $89$ \\ %\hline
      Spot colatitude $\thetas$ ($\deg$) & $3.2$ & $3.9$ & $5.2$ & $6.4$ & $10$ \\ %\hline %peak bf sm 4.4
      Spot angular size $\rho$ ($\deg$) & $7.0$ & $8.4$ & $10$ & $11$ & $14$ \\ %\hline
      Distance $D$ (kpc) & $2.1$ & $2.2$ & $2.5$ & $3.0$ & $3.0$ \\ \hline
      
      \multicolumn{6}{c}{Equatorial spot with only uniform priors} \\ %\hline
      Radius $\req$ (km) & $8.07$ & $8.21$ & $8.99$ & $10.8$ & $16.1$  \\ %\hline
      Mass $M$ ($\msun$) & $1.0$ & $1.0$ & $1.2$ & $1.4$ & $2.0$  \\ %\hline
      Inclination $i$ ($\deg$) & $3.3$ & $3.7$ & $9.3$ & $18$ & $79$ \\ %\hline
      Spot colatitude $\thetas$ ($\deg$) & $4.6$ & $4.8$ & $9.6$ & $73$ & $77$ \\ %\hline
      ...
      Radius $\req$ (km) & $8.18$ & $9.39$ & $10.9$ & $13.3$ & $14.9$  \\ %\hline
      Mass $M$ ($\msun$) & $1.0$ & $1.2$ & $1.4$ & $1.7$ & $1.8$  \\ %\hline
      Inclination $i$ ($\deg$) & $2.5$ & $3.9$ & $5.3$ & $7.1$ & $13$ \\ %\hline
      Spot colatitude $\thetas$ ($\deg$) & $7.5$ & $60$ & $73$ & $82$ & $89$ \\ %\hline
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}
\centerline{\epsfig{file=fpolfsc.pdf,width=17.0cm}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}
\centerline{\epsfig{file=fpolprf2sc.pdf,width=17.0cm}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}
\centerline{\epsfig{file=feqfsc.pdf,width=17.0cm}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}
\centerline{\epsfig{file=feqprf2sc.pdf,width=17.0cm}}
