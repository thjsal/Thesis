...
(when the spot crosses the plane defined by $\bmath{k}$ and $\bmath{z}$). 
We define the zero of the observer's time coordinate by the time of arrival at the observer 
of a light pulse originating at this moment at the point that is directly below the observer and with a reference distance to the center of the star (e.g. the equator radius of the star). 
...
$\sigma'$.  It differs from $\sigma$ because of relativistic aberration. 
...
\ee
The maximum bending angle corresponds to $\sigma=\pi/2$.
The visibility of the spot is defined by a condition $\cos \sigma>0$. 
