...
Previously the constraints of neutron star masses and radii with synthetic data have been studied e.g., by Ka Ho Lo {\it et al}., 2013 \cite{miller} and Miller \& Lamb, 2015 \cite{millerlamb2015}. %(for future space missions).   
...
In case of non-uniform priors for $\thetas$ and $i$ (Figures \ref{fig:polpostpr} and \ref{fig:eqpostpr}), we find the correct solutions for $\thetas$ and $i$ because our prior distributions are centered around the correct values. %even though our prior distributions are not centered  around the correct values. 
In case of the polar spot, $\thetas$ is now between $3 \degree$ and $10 \degree$ with a $95 \%$ probability, and $i$ is larger than $61 \degree$ with a $68 \%$ probability. In case of the equatorial spot, $i$ is between $3 \degree$ and $14 \degree$ with a $95 \%$ probability, and $\thetas$ is larger than $60 \degree$ with a $68 \%$ probability. In both cases the most probable values are close to the correct values (see the Table \ref{table:conflimits}), especially for the smaller one of the angles. The posterior probability distribution for the larger angle is almost entirely determined by the assumed prior probability distribution.  

The non-uniform priors for $\thetas$ and $i$ have also a strong effect on the posterior probability distributions for the mass and the radius. They are now also distributed on both sides of the correct values having the maximum near the correct value. The prior information shifts the probability densities of mass and radius towards higher masses and radii, since the incorrect $\thetas - i$ solutions are in this case not contributing to the small masses and radii so much. Most importantly both the lower and upper limits can now be determined. In case of the polar spot, the radius (correct value $12$ km) is between $10$ km and $13$ km, and the mass (correct value $1.5 ~\msun$) is between $1.2 ~\msun$ and $1.7 ~\msun$, with $68 \%$ probabilities. The most probable values are $12$ km and $1.5 ~\msun$. In case of the equatorial spot and with same the confidence limits, the radius is between $9$ km and $13$ km, and the mass is between $1.2 ~\msun$ and $1.7 ~\msun$. The most probable values are $11$ km and $1.3 ~\msun$. 
  ...
  \begin{tabular}[c]{l c c c c c}
    ...
    \hline
     ...
     \multicolumn{6}{c}{Polar spot with only uniform priors} \\ %\hline
      Radius $\req$ (km) & $8.1$ & $8.3$ & $9.0$ & $12$ & $14$  \\ %\hline
      Mass $M$ ($\msun$) & $1.0$ & $1.1$ & $1.2$ & $1.6$ & $1.7$  \\ %\hline
      Inclination $i$ ($\deg$) & $3.2$ & $3.4$ & $6.2$ & $63$ & $77$ \\ %\hline
      Spot colatitude $\thetas$ ($\deg$) & $3.3$ & $3.4$ & $9.4$ & $71$ & $76$ \\ %\hline
      Spot angular size $\rho$ ($\deg$) & $6.8$ & $8.3$ & $9.8$ & $11$ & $13$ \\ %\hline
      Distance $D$ (kpc) & $2.1$ & $2.2$ & $2.5$ & $3.0$ & $3.0$ \\   \hline
      
      \multicolumn{6}{c}{Polar spot with non-uniform $i$ and $\thetas$ priors} \\ %\hline
      Radius $\req$ (km) & $8.5$ & $9.6$ & $12$ & $13$ & $15$  \\ %\hline
      Mass $M$ ($\msun$) & $1.1$ & $1.2$ & $1.5$ & $1.7$ & $1.9$  \\ %\hline
      Inclination $i$ ($\deg$) & $3.5$ & $61$ & $74$ & $83$ & $89$ \\ %\hline
      Spot colatitude $\thetas$ ($\deg$) & $3.2$ & $4.0$ & $5.2$ & $6.6$ & $10$ \\ %\hline %peak bf sm 4.4
      Spot angular size $\rho$ ($\deg$) & $7.0$ & $8.4$ & $10$ & $12$ & $14$ \\ %\hline
      Distance $D$ (kpc) & $2.1$ & $2.2$ & $2.5$ & $3.0$ & $3.0$ \\ \hline
      
      \multicolumn{6}{c}{Equatorial spot with only uniform priors} \\ %\hline
      Radius $\req$ (km) & $8.1$ & $8.2$ & $9.0$ & $11$ & $16$  \\ %\hline
      Mass $M$ ($\msun$) & $1.0$ & $1.0$ & $1.2$ & $1.4$ & $2.0$  \\ %\hline
      Inclination $i$ ($\deg$) & $3.3$ & $3.7$ & $9.3$ & $18$ & $79$ \\ %\hline
      Spot colatitude $\thetas$ ($\deg$) & $4.6$ & $4.8$ & $9.6$ & $74$ & $77$ \\ %\hline
      Spot angular size $\rho$ ($\deg$) & $6.5$ & $8.7$ & $10$ & $12$ & $13$ \\ %\hline
      Distance $D$ (kpc) &  $2.0$ & $2.1$ & $2.5$ & $2.9$ & $3.0$ \\ \hline
      
      \multicolumn{6}{c}{Equatorial spot with non-uniform $i$ and $\thetas$ priors} \\ %\hline
      Radius $\req$ (km) & $8.2$ & $9.4$ & $11$ & $13$ & $15$  \\ %\hline
      Mass $M$ ($\msun$) & $1.0$ & $1.2$ & $1.3$ & $1.7$ & $1.8$  \\ %\hline
      Inclination $i$ ($\deg$) & $2.5$ & $3.9$ & $5.3$ & $7.2$ & $14$ \\ %\hline
      Spot colatitude $\thetas$ ($\deg$) & $7.3$ & $59$ & $73$ & $82$ & $88$ \\ %\hline
      Spot angular size $\rho$ ($\deg$) & $7.2$ & $8.3$ & $10$ & $11$ & $13$ \\ %\hline
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}
\centerline{\epsfig{file=fpolfs.pdf,width=17.0cm}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}
\centerline{\epsfig{file=fpolprf2s.pdf,width=17.0cm}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}
\centerline{\epsfig{file=feqfs.pdf,width=17.0cm}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}
\centerline{\epsfig{file=feqprf2s.pdf,width=17.0cm}}
