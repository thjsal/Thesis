...
The velocity of the spot in units of $c$ as measured by a local observer is 
\begin{equation}
\label{beta2}
...
Next we can consider otherwise a similar frame but instead of static instantaneous we express the direction of the emitted light in a frame, which is corotating with the spot. Emission angle in the corotating frame relative to the surface normal is denoted by
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}
\centerline{\epsfig{file=ac_fpol.pdf,width=17.0cm}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}
\centerline{\epsfig{file=weights_example.pdf,width=17.0cm}}
\caption{Weights
\label{fig:wexample}}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
