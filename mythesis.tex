...
Of course we also need to take into account that we have different phase shift in the data and in the model. For that reason we calculate the model with five times higher phase resolution than the model. We calculate the probability densities using equation (\ref{eq:gaussprob}) with different phase shifts in order to marginalize over the uncertainty of phase shift. % using all the possible different phase shifts by shifting the values of fluxes in a correct way. 
  ...
  \begin{tabular}[c]{l c c c c c}
    ...
    \hline
     ...
     \multicolumn{6}{c}{Polar spot with only uniform priors} \\ %\hline
      ...
      Spot colatitude $\thetas$ ($\degree$) & $2.8$ & $3.6$ & $5.4$ & $5.5$ & $9.4$ \\ %\hline %peak bf sm 4.4
