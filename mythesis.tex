...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[!ht]
\centerline{\epsfig{file=cad3test.eps,width=11.0cm}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[!ht]
\centerline{\epsfig{file=cad4test.eps,width=11.0cm}}
...
Previously the constraints for neutron star masses and radii with synthetic data have been studied e.g., by Ka Ho Lo {\it et al}. (2013) \cite{miller} and Miller \& Lamb (2015) \cite{millerlamb2015}. %(for future space missions).   
